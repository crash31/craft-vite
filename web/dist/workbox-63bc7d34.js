define("./workbox-63bc7d34.js",['exports'], function (exports) { 'use strict';
    ...
    class PrecacheStrategy extends Strategy {
      ...
      async _handleFetch(request, handler) {
...

        {
          ...
          logger.groupCollapsed(`Precaching is responding to: ` + getFriendlyURL(request.url)); // cacheKey is type any, can't change right now.
